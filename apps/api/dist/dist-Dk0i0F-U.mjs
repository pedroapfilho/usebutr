import { t as createAdapterFactory } from "./factory-Bg7FEB8h.mjs";
import { A as isBoolean, B as noop, C as SchemableIdentifierNode, E as IdentifierNode, F as isNumber, I as isObject, M as isDate, N as isFunction, O as freeze, P as isNull, R as isString, T as ON_COMMIT_ACTIONS, i as CreateViewNode, j as isBuffer, k as isBigInt, m as RawNode, n as DEFAULT_MIGRATION_TABLE, o as WithSchemaPlugin, p as logOnce, r as DefaultQueryCompiler, s as OperationNodeTransformer, t as DEFAULT_MIGRATION_LOCK_TABLE, w as CreateTableNode, z as isUndefined } from "./migrator-CVfj9o-J.mjs";
import { C as parseStringReference, D as isOperationNodeSource, E as ColumnNode, S as parseOrderedColumnName, T as SelectAllNode, _ as QueryNode, a as parseExpression, b as ValueListNode, c as CaseNode, d as QueryExecutorBase, f as provideControlledConnection, g as SelectQueryNode, h as randomString, i as DynamicTableBuilder, l as createFunctionModule, m as createQueryId, n as sql, o as parseDataTypeExpression, p as Deferred, r as parseTable, s as CaseBuilder, t as CompiledQuery, u as QueryCreator, v as parseValueBinaryOperationOrExpression, w as DynamicReferenceBuilder, x as parseColumnName, y as ValueNode } from "./compiled-query-QDhWTL5F.mjs";
import { n as SqliteQueryCompiler, r as DialectAdapterBase, t as SqliteAdapter } from "./sqlite-adapter-BgxwN2TQ.mjs";
...
const createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-na--YwnN-JQAskT6C.mjs");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-DXeH5iWp.mjs");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-C2B7YsIT-CNsmae8u.mjs");
...
//# sourceMappingURL=dist-Dk0i0F-U.mjs.map