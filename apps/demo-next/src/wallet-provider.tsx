...
// EVM-only auto-discovery demo. Proves you can build an EVM-only
// integration with @butr/react + @butr/evm — no @butr/wallets, no SVM
// in the bundle. The discovery loop is ~30 lines of integration code.
...
const WalletProvider = ({ children }: { children: ReactNode }) => {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- captured once
