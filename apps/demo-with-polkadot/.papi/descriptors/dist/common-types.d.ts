...
export type I243algd6inpak = Array<{
    "phase": Phase;
    "event": Anonymize<Ie8mc35d8hcsjq>;
...
export type Ie8mc35d8hcsjq = AnonymousEnum<{
    "System": Anonymize<If1u68loub4orj>;
    "Scheduler": Anonymize<Ib1qv8n84m0v9l>;
    ...
    "Whitelist": Anonymize<I3di2uan23ri81>;
    "Claims": CommonClaimsEvent;
    "Vesting": Anonymize<I7uu9ebnucfti5>;
    "Utility": Anonymize<Ib10b4n0r1krin>;
    "Proxy": Anonymize<I7ijdm9sdn0gc3>;
    "Multisig": Anonymize<I5q2ge6jupnsob>;
    ...
    "FastUnstake": Anonymize<I9srtcr40mfi2b>;
    "DelegatedStaking": Anonymize<I1nq1se98idofq>;
    "StakingAhClient": Anonymize<Ibni7pqnfl3ara>;
    ...
    "Crowdloan": Anonymize<I8tp9gvebbt50e>;
    ...
    "Sudo": Anonymize<Iaple22mj0fi>;
}>;
export type If1u68loub4orj = AnonymousEnum<{
    /**
     ...
     * An extrinsic failed.
     */
    "ExtrinsicFailed": Anonymize<Ibqgao6i9e56pk>;
    /**
     * `:code` was updated.
     */
     ...
     */
    "RejectedInvalidAuthorizedUpgrade": Anonymize<Ia9ppnjq5ecqis>;
}>;
...
export type Ibqgao6i9e56pk = {
    "dispatch_error": Anonymize<Ic24ln2m7ohtfl>;
    "dispatch_info": Anonymize<Ic9s8f85vjtncc>;
};
export type Ic24ln2m7ohtfl = AnonymousEnum<{
    "Other": undefined;
    ...
    "Module": Enum<{
        ...
        "ParaSudoWrapper": Anonymize<I5lft3p1jlcar1>;
...
export type Ia9ppnjq5ecqis = {
    "code_hash": SizedHex<32>;
    "error": Anonymize<Ic24ln2m7ohtfl>;
};
export type Ib1qv8n84m0v9l = AnonymousEnum<{
    /**
     * Scheduled some task.
     */
     ...
     */
    "Dispatched": Anonymize<Ibhtgbpouu6eoo>;
    /**
...
export type I3di2uan23ri81 = AnonymousEnum<{
    "CallWhitelisted": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallRemoved": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallDispatched": Anonymize<I2ad0lpog27pnf>;
}>;
export type I1adbcfi5uc62r = {
    "call_hash": SizedHex<32>;
};
export type I2ad0lpog27pnf = {
    "call_hash": SizedHex<32>;
    "result": Anonymize<I86rmj35r6l32d>;
};
export type I86rmj35r6l32d = ResultPayload<Anonymize<Ia1u1r3n74r13c>, {
...
export type Ib10b4n0r1krin = AnonymousEnum<{
    /**
     * Batch of dispatches did not complete fully. Index of first failing dispatch given, as
     * well as the error.
     */
    "BatchInterrupted": Anonymize<Id72uqa5gs00uf>;
    /**
     ...
     */
    "ItemFailed": Anonymize<I35qals1rqaiaj>;
    /**
     * A call was dispatched.
     */
    "DispatchedAs": Anonymize<Idfnoloi7jvp1d>;
    /**
     ...
     */
    "IfElseFallbackCalled": Anonymize<I7nrl8a1boi4dm>;
}>;
export type Id72uqa5gs00uf = {
    "index": number;
    "error": Anonymize<Ic24ln2m7ohtfl>;
};
export type I35qals1rqaiaj = {
    "error": Anonymize<Ic24ln2m7ohtfl>;
};
export type Idfnoloi7jvp1d = {
    "result": Anonymize<I5gehsf49hauak>;
};
export type I7nrl8a1boi4dm = {
    "main_error": Anonymize<Ic24ln2m7ohtfl>;
};
export type I7ijdm9sdn0gc3 = AnonymousEnum<{
    /**
     * A proxy was executed correctly, with the given.
     */
    "ProxyExecuted": Anonymize<Idfnoloi7jvp1d>;
    /**
     * A pure account has been created by new proxy with given
     * disambiguation index and proxy type.
     */
    "PureCreated": Anonymize<Irvvcklsdj3gf>;
    /**
     * A pure proxy was killed by its spawner.
     */
    "PureKilled": Anonymize<Iatrtbvet29jhn>;
    /**
     ...
     * A proxy was added.
     */
    "ProxyAdded": Anonymize<I8bi6guur4rbev>;
    /**
     * A proxy was removed.
     */
    "ProxyRemoved": Anonymize<I8bi6guur4rbev>;
    /**
     * A deposit stored for proxies or announcements was poked / updated.
     */
    "DepositPoked": Anonymize<I1bhd210c3phjj>;
}>;
export type Irvvcklsdj3gf = {
    "pure": SS58String;
    "who": SS58String;
    "proxy_type": Anonymize<Icbk7p926ddukn>;
    "disambiguation_index": number;
    "at": number;
    "extrinsic_index": number;
};
export type Icbk7p926ddukn = AnonymousEnum<{
    "Any": undefined;
...
export type I5q2ge6jupnsob = AnonymousEnum<{
    /**
     ...
     */
    "MultisigExecuted": Anonymize<I8508ktjtmk82l>;
    /**
...
export type I9srtcr40mfi2b = AnonymousEnum<{
    /**
     * A staker was unstaked.
     */
    "Unstaked": Anonymize<Idleq531fpt8fj>;
    /**
...
export type Ibni7pqnfl3ara = AnonymousEnum<{
    /**
     ...
     */
    "SessionKeysUpdateFailed": Anonymize<I9usv1rfvfo1m8>;
}>;
...
export type I83c8stq532apj = [Anonymize<Ic3531rbp9p138>, Uint8Array, number, number];
export type Ic3531rbp9p138 = {
    "descriptor": Anonymize<I9fbp860cqbr7a>;
    "commitments_hash": SizedHex<32>;
};
export type I9fbp860cqbr7a = {
    ...
    "reserved1": SizedHex<24>;
    "persisted_validation_data_hash": SizedHex<32>;
    "pov_hash": SizedHex<32>;
    "erasure_root": SizedHex<32>;
    "scheduling_parent": SizedHex<32>;
    "reserved2": SizedHex<32>;
    "para_head": SizedHex<32>;
    "validation_code_hash": SizedHex<32>;
};
export type Ifea47889i70b2 = [Anonymize<Ic3531rbp9p138>, Uint8Array, number];
...
export type I3i09nus3ku37s = [SizedHex<32>, ParachainsDisputeLocation];
...
export type I2e447aa6a0imh = [SizedHex<32>, ParachainsDisputeResult];
...
export type I8tp9gvebbt50e = AnonymousEnum<{
    /**
     ...
     */
    "HandleBidResult": Anonymize<I9fg07l7q4eunc>;
    /**
...
export type Iaple22mj0fi = AnonymousEnum<{
    /**
     * A sudo call just took place.
     */
    "Sudid": Anonymize<Ic5h7dpd6ib0je>;
    /**
     ...
     */
    "SudoAsDone": Anonymize<Ic5h7dpd6ib0je>;
}>;
export type Ic5h7dpd6ib0je = {
    /**
     * The result of the call made by the sudo user.
     */
    "sudo_result": Anonymize<I5gehsf49hauak>;
};
...
export type I23nq3fsgtejt = [SizedHex<16>, Uint8Array];
export type Idt624nf41g34e = Array<[SS58String, Anonymize<I9kr8cseidc66h>]>;
export type I9kr8cseidc66h = {
    "grandpa": SizedHex<32>;
    "babe": SizedHex<32>;
    "para_validator": SizedHex<32>;
    "para_assignment": SizedHex<32>;
    "authority_discovery": SizedHex<32>;
    "beefy": SizedHex<33>;
};
...
export type Iuh4e9qmt5ioq = AnonymousEnum<{
    "Ongoing": {
        "track": number;
        "origin": Anonymize<Icqnsdsc2kqh8a>;
        "proposal": PreimagesBounded;
...
export type I9u3tpqiu82up3 = [Array<{
    "delegate": SS58String;
    "proxy_type": Anonymize<Icbk7p926ddukn>;
    "delay": number;
}>, bigint];
...
export type ValidityAttestation = Enum<{
    "Implicit": SizedHex<64>;
    "Explicit": SizedHex<64>;
}>;
...
export type Ibt1op6l47p1r2 = Array<{
    ...
    "session": number;
    "statements": Array<[PolkadotPrimitivesV6DisputeStatement, number, SizedHex<64>]>;
}>;
...
export type PolkadotPrimitivesV6ValidDisputeStatementKind = Enum<{
    "Explicit": undefined;
    "BackingSeconded": SizedHex<32>;
    "BackingValid": SizedHex<32>;
...
export type I2fb54desdqd9n = Array<SizedHex<33>>;
export type Idjett00s2gd = {
    "id": bigint;
    "len": number;
    "keyset_commitment": SizedHex<32>;
};
...
export type I1d6dh9cb9a1ma = AnonymousEnum<{
    /**
     * Anonymously schedule a task.
     */
    "schedule": Anonymize<Icv7tobamjio3l>;
    /**
     ...
     */
    "schedule_named": Anonymize<I3nivhlta38gt9>;
    /**
     ...
     */
    "schedule_after": Anonymize<I69gtrn58u43il>;
    /**
     * Schedule a named task after a delay.
     */
    "schedule_named_after": Anonymize<I4r7c7fk9ejcqn>;
    /**
...
export type Icv7tobamjio3l = {
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type I3nivhlta38gt9 = {
    "id": SizedHex<32>;
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type I69gtrn58u43il = {
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type I4r7c7fk9ejcqn = {
    "id": SizedHex<32>;
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type I2n620m6asdskc = AnonymousEnum<{
    /**
     ...
     * Emits `Submitted`.
     */
    "submit": Anonymize<I2rnfd885vhmhq>;
    /**
...
export type I2rnfd885vhmhq = {
    "proposal_origin": Anonymize<Icqnsdsc2kqh8a>;
    "proposal": PreimagesBounded;
...
export type I1c4bteukkksjh = AnonymousEnum<{
    ...
    "dispatch_whitelisted_call_with_preimage": Anonymize<Iebllebdk7kile>;
}>;
...
export type I3d0e891tdkkd9 = AnonymousEnum<{
    /**
     ...
     * event is deposited.
     */
    "batch": Anonymize<Iaqgmk01apjsqs>;
    /**
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "as_derivative": Anonymize<I7j2fncele0for>;
    /**
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    "batch_all": Anonymize<Iaqgmk01apjsqs>;
    /**
     ...
     * - O(1).
     */
    "dispatch_as": Anonymize<Ie9sbem8urdagi>;
    /**
     * Send a batch of dispatch calls.
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    "force_batch": Anonymize<Iaqgmk01apjsqs>;
    /**
     ...
     * The dispatch origin for this call must be _Root_.
     */
    "with_weight": Anonymize<I71nfp61s664qd>;
    /**
     ...
     * or both.
     */
    "if_else": Anonymize<Idtcm70sibvjg0>;
    /**
     * Dispatches a function call with a provided origin.
     *
     ...
     * The dispatch origin for this call must be _Root_.
     */
    "dispatch_as_fallible": Anonymize<Ie9sbem8urdagi>;
}>;
export type Iaqgmk01apjsqs = {
    "calls": Array<TxCallData>;
};
export type I7j2fncele0for = {
    "index": number;
    "call": TxCallData;
};
export type Ie9sbem8urdagi = {
    "as_origin": Anonymize<Icqnsdsc2kqh8a>;
    "call": TxCallData;
};
export type I71nfp61s664qd = {
    "call": TxCallData;
    "weight": Anonymize<I4q39t5hn830vp>;
};
export type Idtcm70sibvjg0 = {
    "main": TxCallData;
    "fallback": TxCallData;
};
export type I4qur786ufesb3 = AnonymousEnum<{
    /**
     ...
     */
    "proxy": Anonymize<Idpqj5ig3h45tm>;
    /**
     ...
     * zero.
     */
    "add_proxy": Anonymize<Idqm0pk8c418tf>;
    /**
     ...
     */
    "remove_proxy": Anonymize<Idqm0pk8c418tf>;
    /**
     ...
     */
    "create_pure": Anonymize<I897nv1f27d46f>;
    /**
     ...
     */
    "kill_pure": Anonymize<I5v387o7vbn5i4>;
    /**
     ...
     * - `call`: The call to be made by the `real` account.
     */
    "proxy_announced": Anonymize<Iaburjmj86svc9>;
    /**
...
export type Idpqj5ig3h45tm = {
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<I2d3p1op89707u>;
    "call": TxCallData;
};
export type I2d3p1op89707u = (Anonymize<Icbk7p926ddukn>) | undefined;
export type Idqm0pk8c418tf = {
    "delegate": MultiAddress;
    "proxy_type": Anonymize<Icbk7p926ddukn>;
    "delay": number;
};
export type I897nv1f27d46f = {
    "proxy_type": Anonymize<Icbk7p926ddukn>;
    "delay": number;
    "index": number;
};
export type I5v387o7vbn5i4 = {
...
export type Iaburjmj86svc9 = {
    "delegate": MultiAddress;
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<I2d3p1op89707u>;
    "call": TxCallData;
};
export type I4jekccld81r96 = AnonymousEnum<{
    /**
     ...
     */
    "as_multi_threshold_1": Anonymize<If5sk7o4lhh89t>;
    /**
     ...
     */
    "as_multi": Anonymize<I3v3pqusheeu5r>;
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
     * approved by a total of `threshold - 1` of `other_signatories`.
     *
...
export type If5sk7o4lhh89t = {
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "call": TxCallData;
};
export type I3v3pqusheeu5r = {
    "threshold": number;
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
...
export type I3eao7ea0kppv8 = {
    "commitment": {
        "payload": Array<[SizedHex<2>, Uint8Array]>;
        "block_number": number;
...
export type I499ogutcm86mj = {
    ...
    "leaf_count": bigint;
    "items": Array<[bigint, SizedHex<32>]>;
};
...
export type Idsi2hj3q7lfgd = AnonymousEnum<{
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     */
    "sudo": Anonymize<Iebllebdk7kile>;
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     * This function does not check the weight of the call, and instead allows the
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "sudo_unchecked_weight": Anonymize<I71nfp61s664qd>;
    /**
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "sudo_as": Anonymize<I490t4bihso68q>;
    /**
...
export type I490t4bihso68q = {
    "who": MultiAddress;
    "call": TxCallData;
};
export type Ie917s75q8vmif = AnonymousEnum<{
    "System": Anonymize<Iekve0i6djpd9f>;
    "Scheduler": Anonymize<I1d6dh9cb9a1ma>;
    ...
    "Referenda": Anonymize<I2n620m6asdskc>;
    "Whitelist": Anonymize<I1c4bteukkksjh>;
    "Claims": Anonymize<Id0dj18ct09hlp>;
    "Vesting": Anonymize<Icgf8vmtkbnu4u>;
    "Utility": Anonymize<I3d0e891tdkkd9>;
    "Proxy": Anonymize<I4qur786ufesb3>;
    "Multisig": Anonymize<I4jekccld81r96>;
...
export type I33m24pdvqf89l = ResultPayload<Anonymize<I5gehsf49hauak>, Anonymize<I5nrjkj9qumobs>>;
...
export type Ifn3gc8nc1jruq = ([Anonymize<Ifn6q3equiq9qi>, SizedHex<32>]) | undefined;
...
export type Idv6tqqnmb3i1j = Array<[number, SizedHex<32>, Anonymize<I87u7jalc0lhah>]>;
export type If6a2e4ndb6mk6 = (Anonymize<I985vui1sgoafe>) | undefined;
export type Idrp5a1qbbi2au = Array<[number, SizedHex<32>, {
    "keys": Anonymize<Iqnbvitf7a7l3>;
...
export type I6nt209c6sfml3 = Array<[number, SizedHex<32>, Anonymize<Ids3ua6tfbgvj0>]>;
...
export type I25plekc1moieu = {
    "vote": Anonymize<I3eao7ea0kppv8>;
    "ancestry_proof": Uint8Array;
    "header": Anonymize<Ic952bubvq4k7d>;
};
export type I7rj2bnb76oko1 = ResultPayload<SizedHex<32>, MmrPrimitivesError>;
...
export type Ia92qo2nqbt18n = ResultPayload<{
    "execution_result": Anonymize<I86rmj35r6l32d>;
    "emitted_events": Anonymize<Id01c2mmivm6hq>;
    "local_xcm"?: (XcmVersionedXcm) | undefined;
    "forwarded_xcms": Anonymize<Ialhmrpub9sefe>;
}, Anonymize<I55ku9c5gk50hb>>;
export type Id01c2mmivm6hq = Array<Anonymize<Ie8mc35d8hcsjq>>;
export type Ialhmrpub9sefe = Array<[XcmVersionedLocation, Array<XcmVersionedXcm>]>;
export type I55ku9c5gk50hb = AnonymousEnum<{
    "Unimplemented": undefined;
    "VersionedConversionFailed": undefined;
}>;
export type Ifh9jecdin2p9t = ResultPayload<{
