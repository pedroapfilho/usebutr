...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I243algd6inpak>, false, never>;
        /**
    ...
    Scheduler: {
         ...
         */
        Agenda: StorageDescriptor<[Key: number], Anonymize<I2d49nqiu0k3kf>, false, never>;
        /**
    ...
    Babe: {
         ...
         */
        Randomness: StorageDescriptor<[], SizedHex<32>, false, never>;
        /**
         ...
         */
        NextRandomness: StorageDescriptor<[], SizedHex<32>, false, never>;
        /**
    ...
    Offences: {
         ...
         */
        Reports: StorageDescriptor<[Key: SizedHex<32>], Anonymize<I2bqvqrg0sbrdj>, true, never>;
        /**
    ...
    Referenda: {
         ...
         */
        ReferendumInfoFor: StorageDescriptor<[Key: number], Anonymize<Iuh4e9qmt5ioq>, true, never>;
        /**
    ...
    Proxy: {
         ...
         */
        Proxies: StorageDescriptor<[Key: SS58String], Anonymize<I9u3tpqiu82up3>, false, never>;
        /**
    ...
    Paras: {
         ...
         */
        PvfActiveVoteMap: StorageDescriptor<[Key: SizedHex<32>], Anonymize<I4vk12npmr8ll0>, true, never>;
        /**
         ...
         */
        Heads: StorageDescriptor<[Key: number], Uint8Array, true, never>;
        /**
         ...
         */
        CurrentCodeHash: StorageDescriptor<[Key: number], SizedHex<32>, true, never>;
        /**
         ...
         * Corresponding code can be retrieved with [`CodeByHash`].
         */
        PastCodeHash: StorageDescriptor<[Key: Anonymize<I9jd27rnpm8ttv>], SizedHex<32>, true, never>;
        /**
         ...
         * Corresponding code can be retrieved with [`CodeByHash`].
         */
        FutureCodeHash: StorageDescriptor<[Key: number], SizedHex<32>, true, never>;
        /**
         ...
         */
        CodeByHashRefs: StorageDescriptor<[Key: SizedHex<32>], number, false, never>;
        /**
         ...
         * [`PastCodeHash`].
         */
        CodeByHash: StorageDescriptor<[Key: SizedHex<32>], Uint8Array, true, never>;
    };
    Initializer: {
        /**
    ...
    Dmp: {
         ...
         */
        DownwardMessageQueueHeads: StorageDescriptor<[Key: number], SizedHex<32>, false, never>;
        /**
    ...
    Mmr: {
         ...
         */
        RootHash: StorageDescriptor<[], SizedHex<32>, false, never>;
        /**
         ...
         */
        Nodes: StorageDescriptor<[Key: bigint], SizedHex<32>, true, never>;
    };
    BeefyMmrLeaf: {
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<Icv7tobamjio3l>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I3nivhlta38gt9>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I69gtrn58u43il>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I4r7c7fk9ejcqn>>;
        /**
    ...
    Referenda: {
         ...
         * Emits `Submitted`.
         */
        submit: TxDescriptor<Anonymize<I2rnfd885vhmhq>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<Iebllebdk7kile>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Iaqgmk01apjsqs>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I7j2fncele0for>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Iaqgmk01apjsqs>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Ie9sbem8urdagi>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Iaqgmk01apjsqs>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I71nfp61s664qd>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<Idtcm70sibvjg0>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<Ie9sbem8urdagi>>;
    };
    Proxy: {
        /**
         ...
         */
        proxy: TxDescriptor<Anonymize<Idpqj5ig3h45tm>>;
        /**
         ...
         * zero.
         */
        add_proxy: TxDescriptor<Anonymize<Idqm0pk8c418tf>>;
        /**
         ...
         */
        remove_proxy: TxDescriptor<Anonymize<Idqm0pk8c418tf>>;
        /**
         ...
         */
        create_pure: TxDescriptor<Anonymize<I897nv1f27d46f>>;
        /**
         ...
         */
        kill_pure: TxDescriptor<Anonymize<I5v387o7vbn5i4>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Iaburjmj86svc9>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<If5sk7o4lhh89t>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I3v3pqusheeu5r>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<Iebllebdk7kile>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<I71nfp61s664qd>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I490t4bihso68q>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Ibqgao6i9e56pk>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Ia9ppnjq5ecqis>>;
    };
    Scheduler: {
        /**
         * Scheduled some task.
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Ibhtgbpouu6eoo>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<I2ad0lpog27pnf>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Id72uqa5gs00uf>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I35qals1rqaiaj>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<Idfnoloi7jvp1d>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I7nrl8a1boi4dm>>;
    };
    Proxy: {
        /**
         * A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<Idfnoloi7jvp1d>>;
        /**
         * A pure account has been created by new proxy with given
         * disambiguation index and proxy type.
         */
        PureCreated: PlainDescriptor<Anonymize<Irvvcklsdj3gf>>;
        /**
         * A pure proxy was killed by its spawner.
         */
        PureKilled: PlainDescriptor<Anonymize<Iatrtbvet29jhn>>;
        /**
         ...
         * A proxy was added.
         */
        ProxyAdded: PlainDescriptor<Anonymize<I8bi6guur4rbev>>;
        /**
         * A proxy was removed.
         */
        ProxyRemoved: PlainDescriptor<Anonymize<I8bi6guur4rbev>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I8508ktjtmk82l>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<Idleq531fpt8fj>>;
        /**
    ...
    StakingAhClient: {
         ...
         */
        SessionKeysUpdateFailed: PlainDescriptor<Anonymize<I9usv1rfvfo1m8>>;
    };
    ParaInclusion: {
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<I9fg07l7q4eunc>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<Ic5h7dpd6ib0je>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<Ic5h7dpd6ib0je>>;
    };
};
type IError = {
    System: {
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<Ie917s75q8vmif>, proxy_type: Anonymize<Icbk7p926ddukn>], boolean>;
        /**
         * Check if one `ProxyType` is a subset of another `ProxyType`.
         */
        is_superset: RuntimeDescriptor<[to_check: Anonymize<Icbk7p926ddukn>, against: Anonymize<Icbk7p926ddukn>], boolean>;
    };
    VoterList: {
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Uint8Array], Anonymize<I33m24pdvqf89l>>;
        /**
    ...
    ParachainHost: {
         ...
         */
        assumed_validation_data: RuntimeDescriptor<[para_id: number, expected_persisted_validation_data_hash: SizedHex<32>], Anonymize<Ifn3gc8nc1jruq>>;
        /**
         ...
         */
        validation_code_by_hash: RuntimeDescriptor<[hash: SizedHex<32>], Anonymize<Iabpgqcjikia83>>;
        /**
         ...
         * NOTE: This function is only available since parachain host version 2.
         */
        submit_pvf_check_statement: RuntimeDescriptor<[stmt: Anonymize<I36e6rra3ikq65>, signature: SizedHex<64>], undefined>;
        /**
         ...
         */
        key_ownership_proof: RuntimeDescriptor<[validator_id: SizedHex<32>], Anonymize<Iabpgqcjikia83>>;
        /**
         * Submit an unsigned extrinsic to slash validators who lost a dispute about
         * a candidate of a past session.
         * NOTE: This function is only available since parachain host version 5.
         */
        submit_report_dispute_lost: RuntimeDescriptor<[dispute_proof: Anonymize<Ie2h65164u3jsg>, key_ownership_proof: Uint8Array], boolean>;
        /**
         ...
         * ancestor cases.
         */
        ancestor_relay_parent_info: RuntimeDescriptor<[session_index: number, relay_parent: SizedHex<32>], Anonymize<I5i7fh53etglbj>>;
    };
    /**
    ...
    BeefyApi: {
         ...
         */
        submit_report_double_voting_unsigned_extrinsic: RuntimeDescriptor<[equivocation_proof: Anonymize<Ifiofttj73fsk1>, key_owner_proof: Uint8Array], boolean>;
        /**
         ...
         * hardcoded to return `None`). Only useful in an offchain context.
         */
        submit_report_fork_voting_unsigned_extrinsic: RuntimeDescriptor<[equivocation_proof: Anonymize<I25plekc1moieu>, key_owner_proof: Uint8Array], boolean>;
        /**
         ...
         * hardcoded to return `None`). Only useful in an offchain context.
         */
        submit_report_future_block_voting_unsigned_extrinsic: RuntimeDescriptor<[equivocation_proof: Anonymize<I3eao7ea0kppv8>, key_owner_proof: Uint8Array], boolean>;
        /**
         ...
         */
        generate_key_ownership_proof: RuntimeDescriptor<[set_id: bigint, authority_id: SizedHex<33>], Anonymize<Iabpgqcjikia83>>;
    };
    /**
    ...
    MmrApi: {
         ...
         * same position in both the `leaves` vector and the `leaf_indices` vector contained in the [LeafProof]
         */
        verify_proof_stateless: RuntimeDescriptor<[root: SizedHex<32>, leaves: Anonymize<Itom7fk49o0c9>, proof: Anonymize<I38ee9is0n4jn9>], Anonymize<Ie88mmnuvmuvp5>>;
    };
    /**
    ...
    GrandpaApi: {
         ...
         * hardcoded to return `None`). Only useful in an offchain context.
         */
        submit_report_equivocation_unsigned_extrinsic: RuntimeDescriptor<[equivocation_proof: Anonymize<I9puqgoda8ofk4>, key_owner_proof: Uint8Array], boolean>;
        /**
         * Generates a proof of key ownership for the given authority in the
         * given set. An example usage of this module is coupled with the
         * session historical module to prove that a given authority key is
         ...
         * older states to be available.
         */
        generate_key_ownership_proof: RuntimeDescriptor<[set_id: bigint, authority_id: SizedHex<32>], Anonymize<Iabpgqcjikia83>>;
        /**
    ...
    BabeApi: {
         ...
         */
        generate_key_ownership_proof: RuntimeDescriptor<[slot: bigint, authority_id: SizedHex<32>], Anonymize<Iabpgqcjikia83>>;
        /**
         * Submits an unsigned extrinsic to report an equivocation. The caller
         * must provide the equivocation proof and a key ownership proof
         * (should be obtained using `generate_key_ownership_proof`). The
         ...
         * hardcoded to return `None`). Only useful in an offchain context.
         */
        submit_report_equivocation_unsigned_extrinsic: RuntimeDescriptor<[equivocation_proof: Anonymize<I68ii5ik8avr9o>, key_owner_proof: Uint8Array], boolean>;
    };
    /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ie917s75q8vmif>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ie917s75q8vmif>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<Icqnsdsc2kqh8a>, call: Anonymize<Ie917s75q8vmif>, result_xcms_version: number], Anonymize<Ia92qo2nqbt18n>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Ifh9jecdin2p9t>>;
    };
    /**
...
export type PaseoDispatchError = Anonymize<Ic24ln2m7ohtfl>;
...
export type PaseoCallData = Anonymize<Ie917s75q8vmif> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    ...
    tx: {
        ...
        ParaSudoWrapper: ['sudo_schedule_para_initialize', 'sudo_schedule_para_cleanup', 'sudo_schedule_parathread_upgrade', 'sudo_schedule_parachain_downgrade', 'sudo_queue_downward_xcm', 'sudo_establish_hrmp_channel'];
    ...
    errors: {
        ...
        ParaSudoWrapper: ['ParaDoesntExist', 'ParaAlreadyExists', 'ExceedsMaxMessageSize', 'Unroutable', 'CouldntCleanup', 'NotParathread', 'NotParachain', 'CannotUpgrade', 'CannotDowngrade', 'TooManyCores'];
        Sudo: ['RequireSudo'];
    };
    constants: {
