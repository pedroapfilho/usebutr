  ...
  <>
    ...
    <main className="text-foreground-primary mx-auto max-w-2xl px-6 py-10 font-sans" id="main">
      <header className="mb-8">
        <h1 className="text-3xl font-semibold tracking-tight">butr + @solana/web3.js</h1>
        ...
        <p className="border-warning-border bg-warning-surface text-warning-foreground-strong mt-3 rounded-md border p-3 text-xs">
