...
<Callout type="warn">
  ...
  this provider; on native you'd pair through [WalletConnect](/docs/connectors/walletconnect)
  instead.
</Callout>
...
<Callout type="info">
  **Source:** `apps/demo-expo-web/src/wallet-provider.tsx` in the [butr
  ...
  --filter=demo-expo-web` → `http://localhost:8081`. See [custom
  storage](/docs/guides/custom-storage) for the session-storage caveat.
</Callout>
