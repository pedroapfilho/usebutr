...
<Callout type="warn">
  ...
  hydrates on the client — gate UI on [`useIsHydrated()`](/docs/concepts/hydration) so server and
  first client render agree.
</Callout>

<Callout type="info">
  **Source:** `apps/demo-tanstack-start/src/wallet-provider.tsx` in the [butr
  repository](https://github.com/pedroapfilho/butr/tree/main/apps/demo-tanstack-start). Run `pnpm
