...
covers most apps. It also installs `@wallet-standard/app`, which powers Wallet Standard discovery.
...
| `@usebutr/svm`           | `@wallet-standard/app ^1.1.0`                           | Required for discovery; lazily imported. |
| `@usebutr/sui`           | `@wallet-standard/app ^1.1.0`                           | Required for discovery; lazily imported. |
