...
<Callout type="warn">
  **Legacy.** `@solana/web3.js` v1 is in maintenance mode. For new apps, prefer
  [framework-kit](/docs/integrations/solana-framework-kit) (the recommended modern
  stack), [gill](/docs/integrations/gill) (ergonomic, for most apps), or
  [`@solana/kit`](/docs/integrations/solana-kit) (low-level). This page is kept for
  apps still on v1.
</Callout>
