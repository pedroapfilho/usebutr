...
<Callout type="info">
  **Source:** `apps/demo-with-viem/src/app.tsx` in the
  [butr repository](https://github.com/pedroapfilho/butr/tree/main/apps/demo-with-viem).
  Targets Sepolia. Run `pnpm dev --filter=demo-with-viem` →
  `http://localhost:5175`.
</Callout>
