...
<Callout type="info">
  **Source:** `apps/demo-with-wagmi/src/app.tsx` in the [butr
  repository](https://github.com/pedroapfilho/usebutr/tree/main/apps/demo-with-wagmi). Targets Sepolia.
  Run `pnpm dev --filter=demo-with-wagmi` → `http://localhost:5176`.
</Callout>
