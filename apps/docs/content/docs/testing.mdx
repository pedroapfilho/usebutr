...
<Callout type="info">
  **Source:** `packages/testing/src` (`fake-adapter.ts`,
  `fake-persistence.ts`, and their `__tests__`) in the
  [butr repository](https://github.com/pedroapfilho/butr/tree/main/packages/testing).
</Callout>
