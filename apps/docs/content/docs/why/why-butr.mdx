...
[Why butr exists](/docs/why/motivation) covers the problem. This page is the
...
→ [Multi-wallet and chain switching](/docs/guides/multi-chain)
...
→ [Integrations](/docs/integrations/viem)
...
→ [Frameworks](/docs/frameworks/vite)
...
→ [Standards compliance](/docs/concepts/standards) · [Testing](/docs/testing)
