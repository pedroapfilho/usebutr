...
const metadata: Metadata = {
  ...
  title: "Canon — design alternative",
};

const DIRECTION_CONTRACT = `<!--
THESIS: The category standard played straight - an open-source TypeScript library landing at viem's craft level, every fact true, nothing invented; the standing exit of the direction round.
...
FORM: Canon (competitor-benchmarked against viem, user-selected 2026-09-03); seed 4b42851a. No signature interaction by design - the genre's own affordances are the interaction.
FINISH: unreviewed and undocumented is unfinished; this build ends with the finish review, the verdict, DESIGN.md, and every shipping raster carrying its provenance
-->`;

const WALLETS_VERSION = "1.1.2";

// Borders, not shadows: the benchmark declares elevation once. github-light keeps
// code comments above 4.5:1 on white.
const CODE_CLASSES = "border-border border shadow-none ring-0";
...
const Page = () => (
  <div className="bg-background text-foreground min-h-dvh" data-world="canon">
    ...
    <main>
      ...
      <section className="mx-auto w-full max-w-6xl scroll-mt-20 px-6 pt-24 sm:pt-32" id="why">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8">
            <CodeBlock className={CODE_CLASSES} code={OVERVIEW_CODE} theme={CODE_THEME} />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto grid w-full max-w-6xl items-center gap-10 px-6 pt-24 sm:pt-32 lg:grid-cols-2">
        ...
        <CodeBlock className={CODE_CLASSES} code={BRIDGE_CODE} theme={CODE_THEME} />
      </section>
